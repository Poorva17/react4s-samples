...
object DefaultCodeCss extends CssClass(
    S.color(Palette.muted)
)

object KeywordCss extends CssClass(
    S.color(Palette.accent),
)

object UpperCss extends CssClass(
    S.color(Palette.accent),
)

object LowerCss extends CssClass(
    S.color.rgb(18, 75, 96),
)

object StringCss extends CssClass(
    S.color(Palette.muted),
)

object NumberCss extends CssClass(
    S.color(Palette.muted),
)
